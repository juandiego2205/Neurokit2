...
---
Simula señales ECG con distintas frecuencias cardíacas y niveles de ruido:
Simulación de señales EMG
También se exploran simulaciones y análisis de:
  EDA (Electrodermal Activity): respuestas fisiológicas del sistema nervioso simpático.
  RESP (Respiración): señales respiratorias con control sobre frecuencia y duración.
